...
namespace SparkyXUnit
{
    public class CustomerXUnitTests
    {
        ...
        public void CombineName_InputFirstAndLastName_ReturnFullName()
        {
            ...
            Assert.Equal("Hello, Henok Gebrehiwot", customer.GreetMessage);
            Assert.Contains("henok Gebrehiwot".ToLower(), customer.GreetMessage.ToLower());
            Assert.StartsWith("Hello,", customer.GreetMessage);
            Assert.EndsWith("Gebrehiwot", customer.GreetMessage);
